...
async function scrolled() {
  ...
  for (i = 0; document.getElementsByClassName("fade-in").length > i;i++){
    if (document.getElementsByClassName("fade-in")[i].getBoundingClientRect().top < document.documentElement.scrollTop+window.innerHeight) {
      await sleep(100);
